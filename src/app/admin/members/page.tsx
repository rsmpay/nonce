        ...
        <div className="space-y-2">
          {filteredMembers.map((member) => (
            <button
              ...
              className="w-full flex items-center gap-3 p-4 bg-surface rounded-xl hover:bg-surface-light transition-colors text-left"
            >
              <Avatar
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
          ...
          <div className="relative w-full sm:max-w-md bg-surface rounded-t-2xl sm:rounded-2xl p-6 space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-white">멤버 정보</h2>
              <button
                onClick={() => setSelectedMember(null)}
